...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/tianchitest.yml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, 
                        default=ROOT / 'runs/train/pretrain_v5l6f2_wh2880_b12_apxxx/weights/best.pt', 
                        help='model.pt path(s)')
    parser.add_argument('--batch-size', type=int, default=8, help='batch size')
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=2880, help='inference size (pixels)')
    ...
    parser.add_argument('--name', default='v5l6f2_sz2880_b12_conf0.1', help='save to project/name')
